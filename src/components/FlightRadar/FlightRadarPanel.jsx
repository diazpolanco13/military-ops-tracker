...
export default function FlightRadarPanel({ 
  ...
  return (
    <div className="fixed right-4 top-20 bottom-6 w-[360px] bg-slate-900/95 backdrop-blur-md shadow-2xl border border-slate-700 rounded-2xl z-50 flex flex-col overflow-hidden">
